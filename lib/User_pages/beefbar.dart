...
//                         width: 230,
//                         child: Image(
//                             image: AssetImage('asset/beefbar4.jpg'),
//                             fit: BoxFit.cover),
//                       ),
//                       SizedBox(height: 10),
//                     ],
 ...
 width: 200,
        ...
        body: FutureBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            var restaurantData = snapshot.data!.docs[0].data() as Map<String, dynamic>;
            String restaurantId = snapshot.data!.docs[0].id; // Get the document ID
