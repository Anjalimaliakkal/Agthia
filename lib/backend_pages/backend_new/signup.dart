...
class _SignupPageState extends State<SignupPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // appBar: AppBar(
      //   title: Text("Sign Up", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
      //   backgroundColor: Color(0xFF282d37),
      // ),
      backgroundColor:const Color.fromARGB(255, 205, 216, 236),
      body: Center(
        child: Container(
          width: 450,
                ...
                child: Padding(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.asset("asset/logo_agthia.jpg", height: 50),
                    SizedBox(height: 20),
