  ...
  builder: (context, snapshot) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        String name = brand['name'] ?? 'No Name';
       String registerNumber = brand['registerNumber'] ?? 'No registered ID';
        
        Timestamp? timestamp = brand['timestamp'] as Timestamp?;
        ...
        return Card(
          ...
          child: Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Brand Name: $name", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                Text("Registered ID: $registerNumber"),
                Text("Date: $date"),
              ],
            ),
          ),
